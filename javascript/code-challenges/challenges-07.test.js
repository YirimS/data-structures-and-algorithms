...
const sortStarWarsCharacters = (starWarsArr) => { return starWarsArr.sort((a, b) => parseInt(b.height) - parseInt(a.height));
...
const listFoods = (recipe) => {
  let result = [];
  // Solution code here...
  recipe.ingredient.forEach(ingredient.slice(ingredient.indexOf(' ')+ 1);
  return result;
};
